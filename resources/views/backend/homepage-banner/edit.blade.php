                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <a href="{{ viewFile($homepageBanner->video_mp4) }}" target="_blank">Video</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <a href="{{ viewFile($homepageBanner->video_webm) }}" target="_blank">Video</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" cols="30" rows="10">{{ $homepageBanner->description }}</textarea>
