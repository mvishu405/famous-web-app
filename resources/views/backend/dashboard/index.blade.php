<x-backend.backend-layout>
    ...
    <x-slot name="contentHeader">{{ __('Dashboard') }}</x-slot>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control tmce" rows="3" placeholder="Enter ..."></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control float-right pikadatepicker">
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    <!-- Date and time range -->
